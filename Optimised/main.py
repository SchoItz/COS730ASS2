"""
main.py - Optimised system entry point.
Run from project root: python -m optimised.main
"""
import json
...
def create_system(simulation_delay: float = 0.0) -> UI:
    """Factory function: constructs and wires all optimised components."""
    validator = Validator()
