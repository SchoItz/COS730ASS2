"""
metrics.py - Call tracking module for the Optimised system.
Identical interface to baseline/metrics.py — kept separate so both systems
can be instrumented independently during benchmarking.
"""
import time
import functools
